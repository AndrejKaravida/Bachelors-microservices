...
namespace RentACarApi.Controllers
{
    ...
    public class RentacarController : ControllerBase
    {
        ...
        public RentacarController(IRentACarRepository repo, IHttpClientFactory clientFactory, IMapper mapper)
        {
            _repo = repo;
        ...
        {
            if (User.FindFirst(ClaimTypes.NameIdentifier).Value != company.Admin &&
             User.FindFirst(ClaimTypes.NameIdentifier).Value != SystemAdminData.SysAdmin1 &&
             User.FindFirst(ClaimTypes.NameIdentifier).Value != SystemAdminData.SysAdmin2)
                return Unauthorized();
            ...
            {
                return BadRequest("Concurency error" + ex.ToString());
            }
